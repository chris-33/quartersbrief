...
if [[ ! -e "$basepath/tools/wowsunpack/wowsunpack.exe" ]]; then
	...
	mkdir --parents "$basepath/tools/wowsunpack" && curl --silent --output "$basepath/tools/wowsunpack/wowsunpack.exe" https://dl-wows-gc.wargaming.net/projects/mods/wowsunpack.exe
else
