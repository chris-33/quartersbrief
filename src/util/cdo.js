...
*/
ComplexDataObject.createGetters = function(obj, definitions) {
...
// 	constructor(data) {
// 		if (data != null) {
// 			// Make a shallow copy of the source data
// 			data = Object.create(Object.getPrototypeOf(data), Object.getOwnPropertyDescriptors(data));
